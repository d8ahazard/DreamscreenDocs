...
public final class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        public static IntentBuilder from(AppCompatActivity launchingActivity) {
            return new IntentBuilder(launchingActivity);
        }

        private IntentBuilder(AppCompatActivity launchingActivity) {
    ...
    public static class IntentReader {
        ...
        public static IntentReader from(AppCompatActivity activity) {
            return new IntentReader(activity);
        }

        private IntentReader(AppCompatActivity activity) {
    ...
    public static String getCallingPackage(AppCompatActivity calledActivity) {
    ...
    public static ComponentName getCallingActivity(AppCompatActivity calledActivity) {
    ...
    public static void configureMenuItem(MenuItem item, IntentBuilder shareIntent) {
        ...
        ActionProvider itemProvider = MenuItemCompat.getActionProvider(item);
