...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    public View getItemView(MenuItemImpl item, View convertView, ViewGroup parent) {
        ...
        actionView.setVisibility(MenuItemCompat.isActionViewExpanded(item) ? 8 : 0);
    ...
    public void updateMenuView(boolean cleared) {
        ...
        if (this.mReserveOverflow && nonActionItems != null) {
            ...
            hasOverflow = count2 == 1 ? !MenuItemCompat.isActionViewExpanded(((MenuItemImpl) nonActionItems.get(0))) : count2 > 0;
        }
        if (hasOverflow) {
            if (this.mOverflowButton == null) {
                this.mOverflowButton = new OverflowMenuButton(this.mSystemContext);
    ...
    public boolean flagActionItems() {
        ...
        for (int i = 0; i < itemsSize; i++) {
            ...
            if (this.mExpandedActionViewsExclusive && MenuItemCompat.isActionViewExpanded(item)) {
                maxActions = 0;
            }
        }
