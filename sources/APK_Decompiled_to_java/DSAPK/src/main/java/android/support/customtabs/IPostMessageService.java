        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 2:
                    ...
                    ICustomTabsCallback _arg0 = androidx.browser.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    ICustomTabsCallback _arg02 = androidx.browser.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
