...
class FragmentTransitionCompat21 extends FragmentTransitionImpl {
    ...
    public void scheduleRemoveTargets(Object overallTransitionObj, Object enterTransition, ArrayList<View> enteringViews, Object exitTransition, ArrayList<View> exitingViews, Object sharedElementTransition, ArrayList<View> sharedElementsIn) {
        ...
        ((Transition) overallTransitionObj).addListener(new TransitionListener() {
            public void onTransitionStart(Transition transition) {
                if (obj != null) {
                    androidx.fragment.app.FragmentTransitionCompat21.this.replaceTargets(obj, arrayList, null);
                }
                if (obj2 != null) {
                    androidx.fragment.app.FragmentTransitionCompat21.this.replaceTargets(obj2, arrayList2, null);
                }
                if (obj3 != null) {
                    androidx.fragment.app.FragmentTransitionCompat21.this.replaceTargets(obj3, arrayList3, null);
                }
            }
