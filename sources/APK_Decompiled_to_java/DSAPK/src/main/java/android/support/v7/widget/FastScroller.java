...
class FastScroller extends ItemDecoration implements OnItemTouchListener {
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animation) {
            if (this.mCanceled) {
                this.mCanceled = false;
            } else if (((Float) androidx.recyclerview.widget.FastScroller.this.mShowHideAnimator.getAnimatedValue()).floatValue() == 0.0f) {
    ...
    private class AnimatorUpdater implements AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            androidx.recyclerview.widget.FastScroller.this.mVerticalThumbDrawable.setAlpha(alpha);
            androidx.recyclerview.widget.FastScroller.this.mVerticalTrackDrawable.setAlpha(alpha);
            androidx.recyclerview.widget.FastScroller.this.requestRedraw();
        }
    }
