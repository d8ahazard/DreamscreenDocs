    ...
    class AnchorInfo {
        ...
        public void assignCoordinateFromPadding() {
            ...
            if (this.mLayoutFromEnd) {
                startAfterPadding = androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding();
            } else {
                startAfterPadding = androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
            }
        ...
        public void assignFromViewAndKeepVisibleRect(View child) {
            int spaceChange = androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getTotalSpaceChange();
            if (spaceChange >= 0) {
                assignFromView(child);
                return;
            }
            this.mPosition = androidx.recyclerview.widget.LinearLayoutManager.this.getPosition(child);
            if (this.mLayoutFromEnd) {
                int previousEndMargin = (androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - spaceChange) - androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(child);
                this.mCoordinate = androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - previousEndMargin;
                if (previousEndMargin > 0) {
                    int estimatedChildStart = this.mCoordinate - androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getDecoratedMeasurement(child);
                    int layoutStart = androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
                    int startMargin = estimatedChildStart - (layoutStart + Math.min(androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(child) - layoutStart, 0));
                    if (startMargin < 0) {
            ...
            int childStart = androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(child);
            int startMargin2 = childStart - androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
            this.mCoordinate = childStart;
            if (startMargin2 > 0) {
                int endMargin = (androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - Math.min(0, (androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - spaceChange) - androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(child))) - (childStart + androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getDecoratedMeasurement(child));
                if (endMargin < 0) {
        ...
        public void assignFromView(View child) {
            if (this.mLayoutFromEnd) {
                this.mCoordinate = androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getDecoratedEnd(child) + androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getTotalSpaceChange();
            } else {
                this.mCoordinate = androidx.recyclerview.widget.LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(child);
            }
            this.mPosition = androidx.recyclerview.widget.LinearLayoutManager.this.getPosition(child);
        }
    }
