...
public class ViewPager extends ViewGroup {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, androidx.viewpager.widget.ViewPager.LAYOUT_ATTRS);
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == 4096 && androidx.viewpager.widget.ViewPager.this.mAdapter != null) {
                event.setItemCount(androidx.viewpager.widget.ViewPager.this.mAdapter.getCount());
                event.setFromIndex(androidx.viewpager.widget.ViewPager.this.mCurItem);
                event.setToIndex(androidx.viewpager.widget.ViewPager.this.mCurItem);
            }
        }
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            ...
            switch (action) {
                case 4096:
                    ...
                    androidx.viewpager.widget.ViewPager.this.setCurrentItem(androidx.viewpager.widget.ViewPager.this.mCurItem + 1);
                    return true;
                case 8192:
                    if (!androidx.viewpager.widget.ViewPager.this.canScrollHorizontally(-1)) {
                        return false;
    ...
    public interface OnAdapterChangeListener {
        void onAdapterChanged(@NonNull androidx.viewpager.widget.ViewPager viewPager, @Nullable PagerAdapter pagerAdapter, @Nullable PagerAdapter pagerAdapter2);
    }
    ...
    public void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() {
            ...
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat originalInsets) {
                ...
                int count = androidx.viewpager.widget.ViewPager.this.getChildCount();
                for (int i = 0; i < count; i++) {
                    WindowInsetsCompat childInsets = ViewCompat.dispatchApplyWindowInsets(androidx.viewpager.widget.ViewPager.this.getChildAt(i), applied);
