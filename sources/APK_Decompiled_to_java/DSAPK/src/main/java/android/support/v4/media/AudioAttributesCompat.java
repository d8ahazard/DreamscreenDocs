...
public class AudioAttributesCompat {
    ...
    public static class Builder {
        ...
        public Builder(androidx.media.AudioAttributesCompat aa) {
        ...
        public androidx.media.AudioAttributesCompat build() {
            if (androidx.media.AudioAttributesCompat.sForceLegacyBehavior || VERSION.SDK_INT < 21) {
                androidx.media.AudioAttributesCompat aac = new androidx.media.AudioAttributesCompat();
                ...
                return androidx.media.AudioAttributesCompat.wrap(this.mAAObject);
            } else {
                ...
                return androidx.media.AudioAttributesCompat.wrap(api21Builder.build());
            }
        }
        ...
        public Builder setUsage(int usage) {
            switch (usage) {
                ...
                case 15:
                    ...
                    break;
                case 16:
                    if (!androidx.media.AudioAttributesCompat.sForceLegacyBehavior && VERSION.SDK_INT > 25) {
                        this.mUsage = usage;
                        break;
                    } else {
                        this.mUsage = 12;
        ...
        public Builder setFlags(int flags) {
            this.mFlags |= flags & androidx.media.AudioAttributesCompat.FLAG_ALL;
            return this;
        }
        ...
        public Builder setLegacyStreamType(int streamType) {
            ...
            this.mUsage = androidx.media.AudioAttributesCompat.usageForStreamType(streamType);
            return this;
        }
    }
    ...
    @Nullable
    public static androidx.media.AudioAttributesCompat wrap(@NonNull Object aa) {
        if (VERSION.SDK_INT < 21 || sForceLegacyBehavior) {
            return null;
        }
        androidx.media.AudioAttributesCompat aac = new androidx.media.AudioAttributesCompat();
    ...
    static int toVolumeStreamType(boolean fromGetVolumeControlStream, androidx.media.AudioAttributesCompat aa) {
    ...
    public boolean equals(Object o) {
        ...
        androidx.media.AudioAttributesCompat that = (androidx.media.AudioAttributesCompat) o;
        if (VERSION.SDK_INT >= 21 && !sForceLegacyBehavior && this.mAudioAttributesWrapper != null) {
