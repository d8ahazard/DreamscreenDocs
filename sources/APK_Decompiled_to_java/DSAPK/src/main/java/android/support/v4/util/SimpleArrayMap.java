...
public class SimpleArrayMap<K, V> {
    ...
    public SimpleArrayMap(androidx.collection.SimpleArrayMap<K, V> map) {
        this();
        if (map != null) {
            putAll(map);
        }
    ...
    public void putAll(androidx.collection.SimpleArrayMap<? extends K, ? extends V> array) {
        int N = array.mSize;
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof androidx.collection.SimpleArrayMap) {
            androidx.collection.SimpleArrayMap<?, ?> map = (androidx.collection.SimpleArrayMap) object;
            if (size() != map.size()) {
                return false;
            }
            int i = 0;
