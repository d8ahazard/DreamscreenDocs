...
public class FrameMetricsAggregator {
    ...
    private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        private ArrayList<WeakReference<AppCompatActivity>> mActivities = new ArrayList<>();
    ...
    public void add(@NonNull AppCompatActivity activity) {
        this.mInstance.add(activity);
    }

    @Nullable
    public SparseIntArray[] remove(@NonNull AppCompatActivity activity) {
