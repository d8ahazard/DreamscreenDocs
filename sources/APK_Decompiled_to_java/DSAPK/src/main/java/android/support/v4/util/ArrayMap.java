        ...
        if (this.mCollections == null) {
            this.mCollections = new MapCollections<K, V>() {
                ...
                public Object colGetEntry(int index, int offset) {
                    return androidx.collection.ArrayMap.this.mArray[(index << 1) + offset];
                }

                /* access modifiers changed from: protected */
                public int colIndexOfKey(Object key) {
                    return androidx.collection.ArrayMap.this.indexOfKey(key);
                }

                /* access modifiers changed from: protected */
                public int colIndexOfValue(Object value) {
                    return androidx.collection.ArrayMap.this.indexOfValue(value);
                }
                ...
                public void colPut(K key, V value) {
                    androidx.collection.ArrayMap.this.put(key, value);
                }

                /* access modifiers changed from: protected */
                public V colSetValue(int index, V value) {
                    return androidx.collection.ArrayMap.this.setValueAt(index, value);
                }

                /* access modifiers changed from: protected */
                public void colRemoveAt(int index) {
                    androidx.collection.ArrayMap.this.removeAt(index);
                }
