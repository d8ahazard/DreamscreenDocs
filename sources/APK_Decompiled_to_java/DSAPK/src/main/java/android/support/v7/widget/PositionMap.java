...
class PositionMap<E> implements Cloneable {
    ...
    public androidx.recyclerview.widget.PositionMap<E> clone() {
        androidx.recyclerview.widget.PositionMap<E> clone = null;
        try {
            clone = (androidx.recyclerview.widget.PositionMap) super.clone();
