...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final VH createViewHolder(ViewGroup parent, int viewType) {
            TraceCompat.beginSection(androidx.recyclerview.widget.RecyclerView.TRACE_CREATE_VIEW_TAG);
        ...
        public final void bindViewHolder(VH holder, int position) {
            ...
            TraceCompat.beginSection(androidx.recyclerview.widget.RecyclerView.TRACE_BIND_VIEW_TAG);
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimatorListener {
        ...
        public void onAnimationFinished(ViewHolder item) {
            ...
            if (!item.shouldBeKeptAsChild() && !androidx.recyclerview.widget.RecyclerView.this.removeAnimatingView(item.itemView) && item.isTmpDetached()) {
                androidx.recyclerview.widget.RecyclerView.this.removeDetachedView(item.itemView, false);
            }
        }
    }
    ...
    public static abstract class ItemDecoration {
        ...
        @Deprecated
        public void onDraw(Canvas c, androidx.recyclerview.widget.RecyclerView parent) {
        }

        public void onDrawOver(Canvas c, androidx.recyclerview.widget.RecyclerView parent, State state) {
            onDrawOver(c, parent);
        }

        @Deprecated
        public void onDrawOver(Canvas c, androidx.recyclerview.widget.RecyclerView parent) {
        }
    ...
    public static abstract class LayoutManager {
        ...
        /* access modifiers changed from: 0000 */
        public void dispatchAttachedToWindow(androidx.recyclerview.widget.RecyclerView view) {
            this.mIsAttachedToWindow = true;
            onAttachedToWindow(view);
        }

        /* access modifiers changed from: 0000 */
        public void dispatchDetachedFromWindow(androidx.recyclerview.widget.RecyclerView view, Recycler recycler) {
        ...
        @CallSuper
        public void onDetachedFromWindow(androidx.recyclerview.widget.RecyclerView view, Recycler recycler) {
        ...
        public void smoothScrollToPosition(androidx.recyclerview.widget.RecyclerView recyclerView, State state, int position) {
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ViewHolder holder = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(child);
        ...
        public View findViewByPosition(int position) {
            ...
            for (int i = 0; i < childCount; i++) {
                View child = getChildAt(i);
                ViewHolder vh = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(child);
        ...
        public void ignoreView(View view) {
            ...
            ViewHolder vh = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(view);
            vh.addFlags(128);
        ...
        private void scrapOrRecycleView(Recycler recycler, int index, View view) {
            ViewHolder viewHolder = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(view);
        ...
        public void removeAndRecycleScrapInt(Recycler recycler) {
            ...
            for (int i = scrapCount - 1; i >= 0; i--) {
                ...
                ViewHolder vh = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(scrap);
                if (!vh.shouldIgnore()) {
        ...
        private int[] getChildRectangleOnScreenScrollAmount(androidx.recyclerview.widget.RecyclerView parent, View child, Rect rect, boolean immediate) {
            int dx;
            int dy;
            int[] out = new int[2];
        ...
        public boolean requestChildRectangleOnScreen(androidx.recyclerview.widget.RecyclerView parent, View child, Rect rect, boolean immediate) {
            return requestChildRectangleOnScreen(parent, child, rect, immediate, false);
        }

        public boolean requestChildRectangleOnScreen(androidx.recyclerview.widget.RecyclerView parent, View child, Rect rect, boolean immediate, boolean focusedChildVisible) {
        ...
        @Deprecated
        public boolean onRequestChildFocus(androidx.recyclerview.widget.RecyclerView parent, View child, View focused) {
            return isSmoothScrolling() || parent.isComputingLayout();
        }

        public boolean onRequestChildFocus(androidx.recyclerview.widget.RecyclerView parent, State state, View child, View focused) {
        ...
        public boolean onAddFocusables(androidx.recyclerview.widget.RecyclerView recyclerView, ArrayList<View> arrayList, int direction, int focusableMode) {
            return false;
        }
        ...
        public void onItemsUpdated(androidx.recyclerview.widget.RecyclerView recyclerView, int positionStart, int itemCount, Object payload) {
        ...
        public void removeAndRecycleAllViews(Recycler recycler) {
            for (int i = getChildCount() - 1; i >= 0; i--) {
                if (!androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(getChildAt(i)).shouldIgnore()) {
        ...
        public void onInitializeAccessibilityNodeInfoForItem(View host, AccessibilityNodeInfoCompat info) {
            ViewHolder vh = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(host);
    ...
    public interface OnItemTouchListener {
        boolean onInterceptTouchEvent(androidx.recyclerview.widget.RecyclerView recyclerView, MotionEvent motionEvent);

        void onRequestDisallowInterceptTouchEvent(boolean z);

        void onTouchEvent(androidx.recyclerview.widget.RecyclerView recyclerView, MotionEvent motionEvent);
    }
    ...
    public final class Recycler {
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder holder) {
            ...
            if (holder.mPosition < 0 || holder.mPosition >= androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemCount()) {
                throw new IndexOutOfBoundsException("Inconsistency detected. Invalid view holder adapter position" + holder + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
            } else if (!androidx.recyclerview.widget.RecyclerView.this.mState.isPreLayout() && androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemViewType(holder.mPosition) != holder.getItemViewType()) {
                return false;
            } else {
                if (!androidx.recyclerview.widget.RecyclerView.this.mAdapter.hasStableIds() || holder.getItemId() == androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemId(holder.mPosition)) {
                    return true;
                }
                return false;
            }
        ...
        private boolean tryBindViewHolderByDeadline(ViewHolder holder, int offsetPosition, int position, long deadlineNs) {
            ...
            long startBindNs = androidx.recyclerview.widget.RecyclerView.this.getNanoTime();
            if (deadlineNs != androidx.recyclerview.widget.RecyclerView.FOREVER_NS && !this.mRecyclerPool.willBindInTime(viewType, startBindNs, deadlineNs)) {
                return false;
            }
            androidx.recyclerview.widget.RecyclerView.this.mAdapter.bindViewHolder(holder, offsetPosition);
            this.mRecyclerPool.factorInBindTime(holder.getItemViewType(), androidx.recyclerview.widget.RecyclerView.this.getNanoTime() - startBindNs);
        ...
        public void bindViewToPosition(View view, int position) {
            ...
            ViewHolder holder = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(view);
            if (holder == null) {
                throw new IllegalArgumentException("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter" + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
            }
            int offsetPosition = androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.findPositionOffset(position);
            if (offsetPosition < 0 || offsetPosition >= androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemCount()) {
                throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + position + "(offset:" + offsetPosition + ")." + "state:" + androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount() + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
            }
            tryBindViewHolderByDeadline(holder, offsetPosition, position, androidx.recyclerview.widget.RecyclerView.FOREVER_NS);
            android.view.ViewGroup.LayoutParams lp = holder.itemView.getLayoutParams();
            if (lp == null) {
                rvLayoutParams = (LayoutParams) androidx.recyclerview.widget.RecyclerView.this.generateDefaultLayoutParams();
                holder.itemView.setLayoutParams(rvLayoutParams);
            } else if (!androidx.recyclerview.widget.RecyclerView.this.checkLayoutParams(lp)) {
                rvLayoutParams = (LayoutParams) androidx.recyclerview.widget.RecyclerView.this.generateLayoutParams(lp);
                holder.itemView.setLayoutParams(rvLayoutParams);
            } else {
        ...
        public int convertPreLayoutPositionToPostLayout(int position) {
            if (position >= 0 && position < androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount()) {
                return !androidx.recyclerview.widget.RecyclerView.this.mState.isPreLayout() ? position : androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.findPositionOffset(position);
            }
            throw new IndexOutOfBoundsException("invalid position " + position + ". State " + "item count is " + androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount() + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
        }
        ...
        public View getViewForPosition(int position, boolean dryRun) {
            return tryGetViewHolderForPositionByDeadline(position, dryRun, androidx.recyclerview.widget.RecyclerView.FOREVER_NS).itemView;
        }
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            LayoutParams rvLayoutParams;
            if (position < 0 || position >= androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount()) {
                throw new IndexOutOfBoundsException("Invalid item position " + position + "(" + position + "). Item count:" + androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount() + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
            }
                ...
                if (holder != null) {
                    if (!validateViewHolderForOffsetPosition(holder)) {
                        if (!dryRun) {
                            holder.addFlags(4);
                            if (holder.isScrap()) {
                                androidx.recyclerview.widget.RecyclerView.this.removeDetachedView(holder.itemView, false);
                                holder.unScrap();
            ...
            if (holder == null) {
                ...
                int type = androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemViewType(offsetPosition);
                if (androidx.recyclerview.widget.RecyclerView.this.mAdapter.hasStableIds()) {
                    holder = getScrapOrCachedViewForId(androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemId(offsetPosition), type, dryRun);
                    if (holder != null) {
                ...
                if (holder == null && this.mViewCacheExtension != null) {
                    ...
                    if (view != null) {
                        holder = androidx.recyclerview.widget.RecyclerView.this.getChildViewHolder(view);
                        if (holder == null) {
                            throw new IllegalArgumentException("getViewForPositionAndType returned a view which does not have a ViewHolder" + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
                        } else if (holder.shouldIgnore()) {
                            throw new IllegalArgumentException("getViewForPositionAndType returned a view that is ignored. You must call stopIgnoring before returning this view." + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
                        }
                    }
                }
                if (holder == null) {
                ...
                if (holder2 == null) {
                    long start = androidx.recyclerview.widget.RecyclerView.this.getNanoTime();
                    if (deadlineNs == androidx.recyclerview.widget.RecyclerView.FOREVER_NS || this.mRecyclerPool.willCreateInTime(type, start, deadlineNs)) {
                        holder = androidx.recyclerview.widget.RecyclerView.this.mAdapter.createViewHolder(androidx.recyclerview.widget.RecyclerView.this, type);
                        if (androidx.recyclerview.widget.RecyclerView.ALLOW_THREAD_GAP_WORK) {
                            androidx.recyclerview.widget.RecyclerView innerView = androidx.recyclerview.widget.RecyclerView.findNestedRecyclerView(holder.itemView);
                            if (innerView != null) {
                                holder.mNestedRecyclerView = new WeakReference<>(innerView);
                            }
                        }
                        this.mRecyclerPool.factorInCreateTime(type, androidx.recyclerview.widget.RecyclerView.this.getNanoTime() - start);
                    } else {
            ...
            if (fromScrapOrHiddenOrCache && !androidx.recyclerview.widget.RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(8192)) {
                holder.setFlags(0, 8192);
                if (androidx.recyclerview.widget.RecyclerView.this.mState.mRunSimpleAnimations) {
                    androidx.recyclerview.widget.RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(holder, androidx.recyclerview.widget.RecyclerView.this.mItemAnimator.recordPreLayoutInformation(androidx.recyclerview.widget.RecyclerView.this.mState, holder, ItemAnimator.buildAdapterChangeFlagsForAnimations(holder) | 4096, holder.getUnmodifiedPayloads()));
                }
            }
            boolean bound = false;
            if (androidx.recyclerview.widget.RecyclerView.this.mState.isPreLayout() && holder.isBound()) {
                holder.mPreLayoutPosition = position;
            } else if (!holder.isBound() || holder.needsUpdate() || holder.isInvalid()) {
                bound = tryBindViewHolderByDeadline(holder, androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.findPositionOffset(position), position, deadlineNs);
            }
            android.view.ViewGroup.LayoutParams lp = holder.itemView.getLayoutParams();
            if (lp == null) {
                rvLayoutParams = (LayoutParams) androidx.recyclerview.widget.RecyclerView.this.generateDefaultLayoutParams();
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder holder) {
            if (androidx.recyclerview.widget.RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (!ViewCompat.hasAccessibilityDelegate(itemView)) {
                    ...
                    ViewCompat.setAccessibilityDelegate(itemView, androidx.recyclerview.widget.RecyclerView.this.mAccessibilityDelegate.getItemDelegate());
                }
            }
        }
        ...
        public void recycleViewInternal(View view) {
            recycleViewHolderInternal(androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(view));
        }
        ...
        public void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                ...
                throw new IllegalArgumentException(append.append(z).append(androidx.recyclerview.widget.RecyclerView.this.exceptionLabel()).toString());
            } else if (holder.isTmpDetached()) {
                throw new IllegalArgumentException("Tmp detached view should be removed from RecyclerView before it can be recycled: " + holder + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
            } else if (holder.shouldIgnore()) {
                throw new IllegalArgumentException("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle." + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
            } else {
                boolean transientStatePreventsRecycling = holder.doesTransientStatePreventRecycling();
                if (androidx.recyclerview.widget.RecyclerView.this.mAdapter == null || !transientStatePreventsRecycling || !androidx.recyclerview.widget.RecyclerView.this.mAdapter.onFailedToRecycleView(holder)) {
                    forceRecycle = false;
                } else {
                    forceRecycle = true;
                }
                ...
                if (forceRecycle || holder.isRecyclable()) {
                    if (this.mViewCacheMax > 0 && !holder.hasAnyOfTheFlags(526)) {
                        ...
                        if (androidx.recyclerview.widget.RecyclerView.ALLOW_THREAD_GAP_WORK && cachedViewSize > 0 && !androidx.recyclerview.widget.RecyclerView.this.mPrefetchRegistry.lastPrefetchIncludedPosition(holder.mPosition)) {
                            int cacheIndex = cachedViewSize - 1;
                            while (cacheIndex >= 0) {
                                if (!androidx.recyclerview.widget.RecyclerView.this.mPrefetchRegistry.lastPrefetchIncludedPosition(((ViewHolder) this.mCachedViews.get(cacheIndex)).mPosition)) {
                                    break;
                                }
                                cacheIndex--;
                            }
                ...
                androidx.recyclerview.widget.RecyclerView.this.mViewInfoStore.removeViewHolder(holder);
        ...
        public void addViewHolderToRecycledViewPool(ViewHolder holder, boolean dispatchRecycled) {
            androidx.recyclerview.widget.RecyclerView.clearNestedRecyclerViewIfNotNested(holder);
        ...
        public void scrapView(View view) {
            ViewHolder holder = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(view);
            if (!holder.hasAnyOfTheFlags(12) && holder.isUpdated() && !androidx.recyclerview.widget.RecyclerView.this.canReuseUpdatedViewHolder(holder)) {
                if (this.mChangedScrap == null) {
                    this.mChangedScrap = new ArrayList<>();
                }
                holder.setScrapContainer(this, true);
                this.mChangedScrap.add(holder);
            } else if (!holder.isInvalid() || holder.isRemoved() || androidx.recyclerview.widget.RecyclerView.this.mAdapter.hasStableIds()) {
                holder.setScrapContainer(this, false);
                this.mAttachedScrap.add(holder);
            } else {
                throw new IllegalArgumentException("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool." + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
            }
        }
            ...
            if (this.mChangedScrap != null) {
                ...
                if (changedScrapSize != 0) {
                    ...
                    if (androidx.recyclerview.widget.RecyclerView.this.mAdapter.hasStableIds()) {
                        int offsetPosition = androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.findPositionOffset(position);
                        if (offsetPosition > 0 && offsetPosition < androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemCount()) {
                            long id = androidx.recyclerview.widget.RecyclerView.this.mAdapter.getItemId(offsetPosition);
                            int i2 = 0;
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            while (i < scrapCount) {
                ...
                if (holder.wasReturnedFromScrap() || holder.getLayoutPosition() != position || holder.isInvalid() || (!androidx.recyclerview.widget.RecyclerView.this.mState.mInPreLayout && holder.isRemoved())) {
                    i++;
                } else {
                    holder.addFlags(32);
                    return holder;
            ...
            if (!dryRun) {
                View view = androidx.recyclerview.widget.RecyclerView.this.mChildHelper.findHiddenNonRemovedView(position);
                if (view != null) {
                    ViewHolder vh = androidx.recyclerview.widget.RecyclerView.getChildViewHolderInt(view);
                    androidx.recyclerview.widget.RecyclerView.this.mChildHelper.unhide(view);
                    int layoutIndex = androidx.recyclerview.widget.RecyclerView.this.mChildHelper.indexOfChild(view);
                    if (layoutIndex == -1) {
                        throw new IllegalStateException("layout index should not be -1 after unhiding a view:" + vh + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
                    }
                    androidx.recyclerview.widget.RecyclerView.this.mChildHelper.detachViewFromParent(layoutIndex);
                    scrapView(view);
                    vh.addFlags(8224);
                    return vh;
                }
            ...
            for (int i = this.mAttachedScrap.size() - 1; i >= 0; i--) {
                ...
                if (holder.getItemId() == id && !holder.wasReturnedFromScrap()) {
                    if (type == holder.getItemViewType()) {
                        holder.addFlags(32);
                        if (!holder.isRemoved() || androidx.recyclerview.widget.RecyclerView.this.mState.isPreLayout()) {
                            return holder;
                        }
        ...
        public void dispatchViewRecycled(ViewHolder holder) {
            if (androidx.recyclerview.widget.RecyclerView.this.mRecyclerListener != null) {
                androidx.recyclerview.widget.RecyclerView.this.mRecyclerListener.onViewRecycled(holder);
            }
            if (androidx.recyclerview.widget.RecyclerView.this.mAdapter != null) {
                androidx.recyclerview.widget.RecyclerView.this.mAdapter.onViewRecycled(holder);
            }
        ...
        public void setRecycledViewPool(RecycledViewPool pool) {
            ...
            if (pool != null) {
                this.mRecyclerPool.attach(androidx.recyclerview.widget.RecyclerView.this.getAdapter());
            }
        }
    ...
    private class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onChanged() {
            ...
            androidx.recyclerview.widget.RecyclerView.this.setDataSetChangedAfterLayout();
        ...
        public void onItemRangeChanged(int positionStart, int itemCount, Object payload) {
            androidx.recyclerview.widget.RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.onItemRangeChanged(positionStart, itemCount, payload)) {
        ...
        public void onItemRangeInserted(int positionStart, int itemCount) {
            androidx.recyclerview.widget.RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.onItemRangeInserted(positionStart, itemCount)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            androidx.recyclerview.widget.RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.onItemRangeRemoved(positionStart, itemCount)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
            androidx.recyclerview.widget.RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (androidx.recyclerview.widget.RecyclerView.this.mAdapterHelper.onItemRangeMoved(fromPosition, toPosition, itemCount)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void triggerUpdateProcessor() {
            ...
            ViewCompat.postOnAnimation(androidx.recyclerview.widget.RecyclerView.this, androidx.recyclerview.widget.RecyclerView.this.mUpdateChildViewsRunnable);
        }
    }
    ...
    public static abstract class SmoothScroller {
        ...
        /* access modifiers changed from: 0000 */
        public void start(androidx.recyclerview.widget.RecyclerView recyclerView, LayoutManager layoutManager) {
            this.mRecyclerView = recyclerView;
    ...
    class ViewFlinger implements Runnable {
        ...
        Interpolator mInterpolator = androidx.recyclerview.widget.RecyclerView.sQuinticInterpolator;
        ...
        ViewFlinger() {
            this.mScroller = new OverScroller(androidx.recyclerview.widget.RecyclerView.this.getContext(), androidx.recyclerview.widget.RecyclerView.sQuinticInterpolator);
        }
        ...
        public void run() {
            ...
            SmoothScroller smoothScroller = androidx.recyclerview.widget.RecyclerView.this.mLayout.mSmoothScroller;
            if (scroller.computeScrollOffset()) {
                int[] scrollConsumed = androidx.recyclerview.widget.RecyclerView.this.mScrollConsumed;
                ...
                int overscrollX = 0;
                int overscrollY = 0;
                if (androidx.recyclerview.widget.RecyclerView.this.dispatchNestedPreScroll(dx, dy, scrollConsumed, null, 1)) {
                    dx -= scrollConsumed[0];
                    dy -= scrollConsumed[1];
                }
                if (androidx.recyclerview.widget.RecyclerView.this.mAdapter != null) {
                    androidx.recyclerview.widget.RecyclerView.this.eatRequestLayout();
                    androidx.recyclerview.widget.RecyclerView.this.onEnterLayoutOrScroll();
                    TraceCompat.beginSection(androidx.recyclerview.widget.RecyclerView.TRACE_SCROLL_TAG);
                    androidx.recyclerview.widget.RecyclerView.this.fillRemainingScrollValues(androidx.recyclerview.widget.RecyclerView.this.mState);
                    if (dx != 0) {
                        hresult = androidx.recyclerview.widget.RecyclerView.this.mLayout.scrollHorizontallyBy(dx, androidx.recyclerview.widget.RecyclerView.this.mRecycler, androidx.recyclerview.widget.RecyclerView.this.mState);
                        overscrollX = dx - hresult;
                    } else {
                        hresult = 0;
                    }
                    if (dy != 0) {
                        vresult = androidx.recyclerview.widget.RecyclerView.this.mLayout.scrollVerticallyBy(dy, androidx.recyclerview.widget.RecyclerView.this.mRecycler, androidx.recyclerview.widget.RecyclerView.this.mState);
                        overscrollY = dy - vresult;
                    }
                    TraceCompat.endSection();
                    androidx.recyclerview.widget.RecyclerView.this.repositionShadowingViews();
                    androidx.recyclerview.widget.RecyclerView.this.onExitLayoutOrScroll();
                    androidx.recyclerview.widget.RecyclerView.this.resumeRequestLayout(false);
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        int adapterSize = androidx.recyclerview.widget.RecyclerView.this.mState.getItemCount();
                        if (adapterSize == 0) {
                            smoothScroller.stop();
                ...
                if (androidx.recyclerview.widget.RecyclerView.this.getOverScrollMode() != 2) {
                    androidx.recyclerview.widget.RecyclerView.this.considerReleasingGlowsOnScroll(dx, dy);
                }
                if (!androidx.recyclerview.widget.RecyclerView.this.dispatchNestedScroll(hresult, vresult, overscrollX, overscrollY, null, 1) && !(overscrollX == 0 && overscrollY == 0)) {
                    ...
                    if (androidx.recyclerview.widget.RecyclerView.this.getOverScrollMode() != 2) {
                        androidx.recyclerview.widget.RecyclerView.this.absorbGlows(velX, velY);
                    }
                ...
                if (!(hresult == 0 && vresult == 0)) {
                    androidx.recyclerview.widget.RecyclerView.this.dispatchOnScrolled(hresult, vresult);
                }
                if (!androidx.recyclerview.widget.RecyclerView.this.awakenScrollBars()) {
                    androidx.recyclerview.widget.RecyclerView.this.invalidate();
                }
                boolean fullyConsumedAny = (dx == 0 && dy == 0) || (dx != 0 && androidx.recyclerview.widget.RecyclerView.this.mLayout.canScrollHorizontally() && hresult == dx) || (dy != 0 && androidx.recyclerview.widget.RecyclerView.this.mLayout.canScrollVertically() && vresult == dy);
                if (scroller.isFinished() || (!fullyConsumedAny && !androidx.recyclerview.widget.RecyclerView.this.hasNestedScrollingParent(1))) {
                    ...
                    if (androidx.recyclerview.widget.RecyclerView.this.mGapWorker != null) {
                        androidx.recyclerview.widget.RecyclerView.this.mGapWorker.postFromTraversal(androidx.recyclerview.widget.RecyclerView.this, dx, dy);
                    }
                }
            }
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            int containerSize = horizontal ? androidx.recyclerview.widget.RecyclerView.this.getWidth() : androidx.recyclerview.widget.RecyclerView.this.getHeight();
            ...
            return Math.min(duration, androidx.recyclerview.widget.RecyclerView.MAX_SCROLL_DURATION);
        }

        public void smoothScrollBy(int dx, int dy, int duration) {
            smoothScrollBy(dx, dy, duration, androidx.recyclerview.widget.RecyclerView.sQuinticInterpolator);
        }
        ...
        public void smoothScrollBy(int dx, int dy, int duration, Interpolator interpolator) {
            if (this.mInterpolator != interpolator) {
                this.mInterpolator = interpolator;
                this.mScroller = new OverScroller(androidx.recyclerview.widget.RecyclerView.this.getContext(), interpolator);
            }
            androidx.recyclerview.widget.RecyclerView.this.setScrollState(2);
            this.mLastFlingY = 0;
            this.mLastFlingX = 0;
    ...
    public static abstract class ViewHolder {
        ...
        /* access modifiers changed from: private */
        public void onEnteredHiddenState(androidx.recyclerview.widget.RecyclerView parent) {
            this.mWasImportantForAccessibilityBeforeHidden = ViewCompat.getImportantForAccessibility(this.itemView);
            parent.setChildImportantForAccessibilityInternal(this, 4);
        }

        /* access modifiers changed from: private */
        public void onLeftHiddenState(androidx.recyclerview.widget.RecyclerView parent) {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
            ...
            public void run() {
                if (androidx.recyclerview.widget.RecyclerView.this.mFirstLayoutComplete && !androidx.recyclerview.widget.RecyclerView.this.isLayoutRequested()) {
                    if (!androidx.recyclerview.widget.RecyclerView.this.mIsAttached) {
                        androidx.recyclerview.widget.RecyclerView.this.requestLayout();
                    } else if (androidx.recyclerview.widget.RecyclerView.this.mLayoutFrozen) {
                        androidx.recyclerview.widget.RecyclerView.this.mLayoutRequestEaten = true;
                    } else {
                        androidx.recyclerview.widget.RecyclerView.this.consumePendingUpdateOperations();
                    }
                }
        ...
        this.mViewInfoProcessCallback = new ProcessCallback() {
            public void processDisappeared(ViewHolder viewHolder, @NonNull ItemHolderInfo info, @Nullable ItemHolderInfo postInfo) {
                ...
                androidx.recyclerview.widget.RecyclerView.this.animateDisappearance(viewHolder, info, postInfo);
            }

            public void processAppeared(ViewHolder viewHolder, ItemHolderInfo preInfo, ItemHolderInfo info) {
                androidx.recyclerview.widget.RecyclerView.this.animateAppearance(viewHolder, preInfo, info);
            }
            ...
            public void processPersistent(ViewHolder viewHolder, @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo) {
                ...
                if (androidx.recyclerview.widget.RecyclerView.this.mDataSetHasChangedAfterLayout) {
                    if (androidx.recyclerview.widget.RecyclerView.this.mItemAnimator.animateChange(viewHolder, viewHolder, preInfo, postInfo)) {
                        androidx.recyclerview.widget.RecyclerView.this.postAnimationRunner();
                    }
                } else if (androidx.recyclerview.widget.RecyclerView.this.mItemAnimator.animatePersistence(viewHolder, preInfo, postInfo)) {
                    androidx.recyclerview.widget.RecyclerView.this.postAnimationRunner();
                }
            }
    ...
    private String getFullClassName(Context context, String className) {
        ...
        return !className.contains(".") ? androidx.recyclerview.widget.RecyclerView.class.getPackage().getName() + '.' + className : className;
    }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new Callback() {
            ...
            public void addView(View child, int index) {
                ...
                androidx.recyclerview.widget.RecyclerView.this.dispatchChildAttached(child);
            }
            ...
            public void removeViewAt(int index) {
                View child = androidx.recyclerview.widget.RecyclerView.this.getChildAt(index);
                if (child != null) {
                    androidx.recyclerview.widget.RecyclerView.this.dispatchChildDetached(child);
            ...
            public void attachViewToParent(View child, int index, android.view.ViewGroup.LayoutParams layoutParams) {
                ...
                if (vh != null) {
                    if (vh.isTmpDetached() || vh.shouldIgnore()) {
                        ...
                        throw new IllegalArgumentException("Called attach on a child which is not detached: " + vh + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
                    }
                }
                ...
                if (view != null) {
                    ...
                    if (vh != null) {
                        if (!vh.isTmpDetached() || vh.shouldIgnore()) {
                            ...
                            throw new IllegalArgumentException("called detach on an already detached child " + vh + androidx.recyclerview.widget.RecyclerView.this.exceptionLabel());
                        }
                    }
                }
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new Callback() {
            public ViewHolder findViewHolder(int position) {
                ViewHolder vh = androidx.recyclerview.widget.RecyclerView.this.findViewHolderForPosition(position, true);
                if (vh == null) {
                    return null;
                }
                if (androidx.recyclerview.widget.RecyclerView.this.mChildHelper.isHidden(vh.itemView)) {
                    return null;
                }
                return vh;
            }
            ...
            public void offsetPositionsForRemovingInvisible(int start, int count) {
                androidx.recyclerview.widget.RecyclerView.this.offsetPositionRecordsForRemove(start, count, true);
                androidx.recyclerview.widget.RecyclerView.this.mItemsAddedOrRemoved = true;
                androidx.recyclerview.widget.RecyclerView.this.mState.mDeletedInvisibleItemCountSincePreviousLayout += count;
            }

            public void offsetPositionsForRemovingLaidOutOrNewView(int positionStart, int itemCount) {
                androidx.recyclerview.widget.RecyclerView.this.offsetPositionRecordsForRemove(positionStart, itemCount, false);
                androidx.recyclerview.widget.RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            public void markViewHoldersUpdated(int positionStart, int itemCount, Object payload) {
                androidx.recyclerview.widget.RecyclerView.this.viewRangeUpdate(positionStart, itemCount, payload);
            ...
            public void dispatchUpdate(UpdateOp op) {
                switch (op.cmd) {
                    case 1:
                        androidx.recyclerview.widget.RecyclerView.this.mLayout.onItemsAdded(androidx.recyclerview.widget.RecyclerView.this, op.positionStart, op.itemCount);
                        return;
                    case 2:
                        androidx.recyclerview.widget.RecyclerView.this.mLayout.onItemsRemoved(androidx.recyclerview.widget.RecyclerView.this, op.positionStart, op.itemCount);
                        return;
                    case 4:
                        androidx.recyclerview.widget.RecyclerView.this.mLayout.onItemsUpdated(androidx.recyclerview.widget.RecyclerView.this, op.positionStart, op.itemCount, op.payload);
                        return;
                    case 8:
                        androidx.recyclerview.widget.RecyclerView.this.mLayout.onItemsMoved(androidx.recyclerview.widget.RecyclerView.this, op.positionStart, op.itemCount, 1);
                        return;
                    default:
                        return;
                }
            ...
            public void offsetPositionsForAdd(int positionStart, int itemCount) {
                androidx.recyclerview.widget.RecyclerView.this.offsetPositionRecordsForInsert(positionStart, itemCount);
                androidx.recyclerview.widget.RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            public void offsetPositionsForMove(int from, int to) {
                androidx.recyclerview.widget.RecyclerView.this.offsetPositionRecordsForMove(from, to);
                androidx.recyclerview.widget.RecyclerView.this.mItemsAddedOrRemoved = true;
            }
        });
    }
    ...
    static androidx.recyclerview.widget.RecyclerView findNestedRecyclerView(@NonNull View view) {
        ...
        for (int i = 0; i < count; i++) {
            androidx.recyclerview.widget.RecyclerView descendant = findNestedRecyclerView(parent.getChildAt(i));
            if (descendant != null) {
                return descendant;
            }
        }
