    ...
    public static abstract class Stub extends Binder implements ICustomTabsService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result2 = newSession(androidx.browser.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result2) {
                        i = 1;
                    }
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ICustomTabsCallback _arg03 = androidx.browser.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    ICustomTabsCallback _arg04 = androidx.browser.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    ICustomTabsCallback _arg05 = androidx.browser.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    ICustomTabsCallback _arg06 = androidx.browser.customtabs.ICustomTabsCallback.Stub.asInterface(data.readStrongBinder());
