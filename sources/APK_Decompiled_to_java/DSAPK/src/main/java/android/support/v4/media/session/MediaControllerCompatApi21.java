...
class MediaControllerCompatApi21 {
    ...
    public static void setMediaController(AppCompatActivity activity, Object controllerObj) {
        activity.setMediaController((MediaController) controllerObj);
    }

    public static Object getMediaController(AppCompatActivity activity) {
