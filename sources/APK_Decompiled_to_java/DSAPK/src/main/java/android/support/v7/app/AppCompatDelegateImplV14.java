...
class AppCompatDelegateImplV14 extends AppCompatDelegateImplV11 {
    ...
    class AppCompatWindowCallbackV14 extends AppCompatWindowCallbackBase {
        ...
        public final ActionMode startAsSupportActionMode(ActionMode.Callback callback) {
            ...
            androidx.appcompat.view.ActionMode supportActionMode = AppCompatDelegateImplV14.this.startSupportActionMode(callbackWrapper);
    ...
    private boolean shouldRecreateOnNightModeChange() {
        if (!this.mApplyDayNightCalled || !(this.mContext instanceof AppCompatActivity)) {
            return false;
        }
        try {
