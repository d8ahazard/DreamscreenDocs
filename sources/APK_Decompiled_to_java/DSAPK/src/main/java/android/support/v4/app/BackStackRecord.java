...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    public boolean generateOps(ArrayList<androidx.fragment.app.BackStackRecord> records, ArrayList<Boolean> isRecordPop) {
        if (FragmentManagerImpl.DEBUG) {
            Log.v(TAG, "Run: " + this);
        }
        records.add(this);
    ...
    /* access modifiers changed from: 0000 */
    public boolean interactsWith(ArrayList<androidx.fragment.app.BackStackRecord> records, int startIndex, int endIndex) {
        ...
        for (int opNum = 0; opNum < numOps; opNum++) {
            ...
            if (!(container == 0 || container == lastContainer)) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    androidx.fragment.app.BackStackRecord record = (androidx.fragment.app.BackStackRecord) records.get(i);
