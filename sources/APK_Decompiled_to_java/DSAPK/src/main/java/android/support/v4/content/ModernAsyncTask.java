...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private final FutureTask<Result> mFuture = new FutureTask<Result>(this.mWorker) {
        ...
        public void done() {
            try {
                ...
                Log.w(androidx.loader.content.ModernAsyncTask.LOG_TAG, e);
    ...
    private final WorkerRunnable<Params, Result> mWorker = new WorkerRunnable<Params, Result>() {
        public Result call() throws Exception {
            ...
            try {
                ...
                result = androidx.loader.content.ModernAsyncTask.this.doInBackground(this.mParams);
    ...
    private static class AsyncTaskResult<Data> {
        ...
        AsyncTaskResult(androidx.loader.content.ModernAsyncTask task, Data... data) {
            this.mTask = task;
            this.mData = data;
        }
    }
    ...
    public final androidx.loader.content.ModernAsyncTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(sDefaultExecutor, params);
    }

    public final androidx.loader.content.ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
