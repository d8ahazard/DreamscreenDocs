    ...
    public LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        ...
        return new LinearSmoothScroller(this.mRecyclerView.getContext()) {
            ...
            public void onTargetFound(View targetView, State state, Action action) {
                int[] snapDistances = androidx.recyclerview.widget.PagerSnapHelper.this.calculateDistanceToFinalSnap(androidx.recyclerview.widget.PagerSnapHelper.this.mRecyclerView.getLayoutManager(), targetView);
