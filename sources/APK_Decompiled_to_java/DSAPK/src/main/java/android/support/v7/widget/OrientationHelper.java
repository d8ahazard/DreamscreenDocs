...
public abstract class OrientationHelper {
    ...
    public static androidx.recyclerview.widget.OrientationHelper createOrientationHelper(LayoutManager layoutManager, int orientation) {
        switch (orientation) {
            case 0:
    ...
    public static androidx.recyclerview.widget.OrientationHelper createHorizontalHelper(LayoutManager layoutManager) {
        return new androidx.recyclerview.widget.OrientationHelper(layoutManager) {
    ...
    public static androidx.recyclerview.widget.OrientationHelper createVerticalHelper(LayoutManager layoutManager) {
        return new androidx.recyclerview.widget.OrientationHelper(layoutManager) {
            public int getEndAfterPadding() {
