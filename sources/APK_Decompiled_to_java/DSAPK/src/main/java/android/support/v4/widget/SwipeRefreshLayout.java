...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public interface OnChildScrollUpCallback {
        boolean canChildScrollUp(@NonNull androidx.swiperefreshlayout.widget.SwipeRefreshLayout swipeRefreshLayout, @Nullable View view);
    }
        ...
        this.mRefreshListener = new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mRefreshing) {
                    ...
                    androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mCurrentTargetOffsetTop = androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mCircleView.getTop();
                    return;
                }
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                if (!androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mUsingCustomStart) {
                    endTarget = androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mSpinnerOffsetEnd - Math.abs(androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mOriginalOffsetTop);
                } else {
                    endTarget = androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mSpinnerOffsetEnd;
                }
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mFrom + ((int) (((float) (endTarget - androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mFrom)) * interpolatedTime))) - androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mCircleView.getTop());
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mProgress.setArrowScale(1.0f - interpolatedTime);
            }
        };
        this.mAnimateToStartPosition = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.moveToStart(interpolatedTime);
            }
        };
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.setAnimationProgress(interpolatedTime);
            }
        };
    ...
    public void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.setAnimationProgress(1.0f - interpolatedTime);
            }
        };
    ...
    private Animation startAlphaAnimation(final int startingAlpha, final int endingAlpha) {
        Animation alpha = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mProgress.setAlpha((int) (((float) startingAlpha) + (((float) (endingAlpha - startingAlpha)) * interpolatedTime)));
            }
        };
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.setAnimationProgress(androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mStartingScale + ((-androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.mStartingScale) * interpolatedTime));
                androidx.swiperefreshlayout.widget.SwipeRefreshLayout.this.moveToStart(interpolatedTime);
            }
        };
