...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static SetIndicatorInfo setActionBarUpIndicator(SetIndicatorInfo info, AppCompatActivity activity, Drawable drawable, int contentDescRes) {
    ...
    public static SetIndicatorInfo setActionBarDescription(SetIndicatorInfo info, AppCompatActivity activity, int contentDescRes) {
        if (info == null) {
    ...
    public static Drawable getThemeUpIndicator(AppCompatActivity activity) {
