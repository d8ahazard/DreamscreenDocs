...
public class ViewDragHelper {
    ...
    public static androidx.customview.widget.ViewDragHelper create(@NonNull ViewGroup forParent, @NonNull Callback cb) {
        return new androidx.customview.widget.ViewDragHelper(forParent.getContext(), forParent, cb);
    }

    public static androidx.customview.widget.ViewDragHelper create(@NonNull ViewGroup forParent, float sensitivity, @NonNull Callback cb) {
        androidx.customview.widget.ViewDragHelper helper = create(forParent, cb);
