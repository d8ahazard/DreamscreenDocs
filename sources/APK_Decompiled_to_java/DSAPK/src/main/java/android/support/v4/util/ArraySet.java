...
public final class ArraySet<E> implements Collection<E>, Set<E> {
    ...
    public ArraySet(androidx.collection.ArraySet<E> set) {
        this();
        if (set != null) {
            addAll(set);
        }
    ...
    public void addAll(androidx.collection.ArraySet<? extends E> array) {
        int N = array.mSize;
    ...
    public boolean removeAll(androidx.collection.ArraySet<? extends E> array) {
        int N = array.mSize;
        ...
        if (this.mCollections == null) {
            this.mCollections = new MapCollections<E, E>() {
                ...
                public Object colGetEntry(int index, int offset) {
                    return androidx.collection.ArraySet.this.mArray[index];
                }

                /* access modifiers changed from: protected */
                public int colIndexOfKey(Object key) {
                    return androidx.collection.ArraySet.this.indexOf(key);
                }

                /* access modifiers changed from: protected */
                public int colIndexOfValue(Object value) {
                    return androidx.collection.ArraySet.this.indexOf(value);
                }
                ...
                public void colPut(E key, E e) {
                    androidx.collection.ArraySet.this.add(key);
                }
